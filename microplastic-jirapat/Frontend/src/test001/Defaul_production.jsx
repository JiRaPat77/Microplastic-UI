      ...
      <nav className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between h-auto sm:h-16 py-3 sm:py-0 gap-3 sm:gap-0">
            ...
            <div className="flex items-center gap-2 sm:space-x-4 overflow-x-auto pb-1 sm:pb-0">
              ...
              <div className="flex items-center gap-2 bg-gray-100 px-3 py-1.5 rounded-md border border-gray-200">
                ...
                <input 
                  ...
                  className="bg-transparent text-sm text-gray-700 focus:outline-none w-auto"
                />
              </div>

              <button 
                onClick={handleExport}
                className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-md text-sm font-medium transition-colors whitespace-nowrap"
              >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-xs sm:text-sm text-gray-500 mt-2">
            {/* <span>ID: {apiData?.analysisId || '#MP-WAITING'}</span> */}
            ...
            {/* <div className="bg-blue-50 rounded-xl border border-blue-100 p-4">
              <div className="flex flex-col sm:flex-row items-start gap-3">
                 ...
                 <div className="w-full">
                   ...
                   <p className="text-blue-700 text-xs mt-1">วันที่เลือก: {selectedDate}</p>
                   <button 
                    onClick={handleExport}
                    className="mt-3 w-full sm:w-auto text-xs bg-blue-600 text-white px-3 py-2 sm:py-1.5 rounded hover:bg-blue-700 transition-colors text-center"
                   >
                     Download PDF for {selectedDate}
                   </button>
                 </div>
              </div>
            </div> */}
